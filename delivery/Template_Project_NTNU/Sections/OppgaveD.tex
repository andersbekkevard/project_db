...
\textbf{1.} Hvordan (eller kan) dere sørge for at en instruktør ikke kan være til stede på to forskjellige plasser samtidig? Kan dere få til dette ved hjelp av modellen deres, eller må noe slikt implementeres i programvaren?

\textbf{2.} Det samme spørsmålet for en bruker. Kan dette løses i modellen eller må det gjøres i programvaren?

\textbf{Svar på spørsmål 1 og 2:}
...
\textbf{3.} Fra hvilket usecase testes det for / opprettes utestengelse (svartelisting)? Det trenger ikke være en av de oppgitte usecasene.

\textbf{Svar på spørsmål 3:}
...
\textbf{4.} Statistikk er det noe som må lagres eksplisitt eller går det an å bare gjøre queries for å få svar? Diskuter dette.

\textbf{Svar på spørsmål 4:}
